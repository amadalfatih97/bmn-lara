                    ...
                    <form action="{{url('/pengguna/add')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3 input-group has-validation">
                                ...
                                {{ $errors->get('perihal') ? 'is-invalid'  : ''}}" id="exampleInputbarang"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 input-group has-validation">
                                    ...
                                    {{ $errors->get('mulai') ? 'is-invalid'  : ''}}" id="exampleInputbarang"
                                        name="mulai" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 input-group has-validation">
                                    ...
                                    {{ $errors->get('kembali') ? 'is-invalid'  : ''}}" id="exampleInputbarang"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3 input-group has-validation">
                                ...
                                {{ $errors->get('ket') ? 'is-invalid'  : ''}}" id="exampleInputbarang"
                                    name="ket" required> </textarea>
                            </div>
                        </div>
                        {{-- ini dipindah ke update page --}}
                        <div class="mb-3">
                            <input name="finish" class="form-check-input" type="checkbox" id="inlineCheckbox2" value="true">
                            <label class="form-check-label" for="inlineCheckbox2">Selesai</label>
                        </div>
                        {{--  --}}
