                ...
                <div class="card p-3 mb-2">
                    <div class="row">
                        ...
                        <div class="col-md-6  mb-2">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" readonly wire:model="selectPemeliharaan.kode">
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="mb-2 input-group has-validation">
                                <input type="date" class="form-control "  data-date-format="DD MMMM YYYY"
                                    required max="{{date('Y-m-d')}}" wire:model="selectPemeliharaan.tglPelaksanaan">
                            </div>
                        </div>
                        <div class="col-md-6  mb-2">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <textarea class="form-control" rows="3" wire:model="selectPemeliharaan.kondisi"></textarea>
                        </div>
                        <div class="col-md-12 mb-2">
                            <label for="ket" class="form-label">Tindakan</label>
                            <textarea class="form-control" rows="3" wire:model="selectPemeliharaan.tindakan"></textarea>
                        </div>
                    </div>
                </div>
