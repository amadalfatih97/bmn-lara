...
<div class="card container-fluid py-3 px-md-4">
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 px-3 text-end align-middle align-self-center hide-to-mobile">
            <span class="fst-italic fs-6 text-secondary">Dashboard > Data User
            </span>
        </div>
    </div>
</div>
<div class="pt-3">
    <div class="container-md px-md-4">
        <div class="card px-3 py-3">
            <div class="row">
                <div class="col-md-8 ">
                    <a href="{{url('user/add')}}" class="btn btn-success mb-2">input</a>
                </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$data->unit}}</td>
                                    <td>
                                        <a class="btn btn-outline-primary" href="/user/{{$data->id}}"><i class="bi bi-pencil-square"></i></button>
                                    </td>
                                    <td>
